...
public class Execute implements Element{
	...
	public void performEX()
	{
		...
		{
			if(OF_EX_Latch.isEX_busyduetoMA())
			{
				return;
			}
			if(!(OF_EX_Latch.isEX_busyduetoMA()))
			{
				OF_EX_Latch.setOF_busyduetoMA(false);
			}
			...
			{
				// OF_EX_Latch.setOF_busyduetoMA(false);
				// System.out.println("in ex in counter");
				counter=0;
				EX_MA_Latch.setinstruction(null);
			...
			{
				// System.out.println("in of ex null");
				EX_MA_Latch.setinstruction(null);
				IF_OF_Latch.setEXinstruction(null);
			...
			else if(OF_EX_Latch.getinstruction()!=null)
			{
				...
				switch(operation)
				{
					...
					case addi:
							...
							OF_EX_Latch.setOF_busyduetoEX(true);
							// System.out.println("hi the add is put into queue");
							result=op1+op2;
							break;
					case sub:
					case subi:
	...
	public void handleEvent(Event event) 
	{
		...
		else
		{
			...
			OF_EX_Latch.setOF_busyduetoEX(false);
