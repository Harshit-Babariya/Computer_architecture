...
public class Statistics {
	...
	public static void setnumber_of_instructions(int number_of_instructions) {
		Statistics.number_of_instructions = number_of_instructions;
	}

	public static int getnumber_of_instructions() {
	...
	public static void printStatistics(String statFile)
	{
		try
		{
			...
			writer.println("number_of_instructions = " + number_of_instructions);
			double IPC = (double)number_of_instructions/numberOfCycles;
